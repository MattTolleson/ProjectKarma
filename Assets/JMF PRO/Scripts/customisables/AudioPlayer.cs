...
public class AudioPlayer : MonoBehaviour {
	...
	public class customAudio{
		...
		public void play(){
			if(audioClip != null && canPlay && JMFUtils.gm.audioScript.enableSoundFX){
				JMFUtils.gm.audioScript.player.PlayOneShot(audioClip);
				JMFUtils.gm.audioScript.StartCoroutine(coolDown(0.1f)); // built-in spam filter
			}
		}
